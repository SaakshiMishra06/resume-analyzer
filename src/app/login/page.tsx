            ...
            {status !== "success" ? (
              ...
              >
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Sign in with your email to continue</p>
                  </div>
              ...
              >
                <CardContent className="p-10 flex flex-col items-center">
                  ...
                  <p className="text-gray-400 text-sm mb-4 max-w-[250px]">
                    We've sent a magic link to <span className="text-white font-medium">{email}</span>
                  </p>
                  <p className="text-xs text-gray-500 italic">Please check your inbox to continue.</p>
                </CardContent>
              </motion.div>
            )}
          </AnimatePresence>
