    ...
    <PageTransition className="min-h-screen bg-black flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <Card className="glass-panel border-white/10 shadow-2xl">
          <CardContent className="p-8">
            ...
            <div className="space-y-4 mb-6">
              <Button variant="outline" className="w-full relative overflow-hidden group border-white/10">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-transparent text-gray-500 glass rounded-full">Or continue with</span>
              </div>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-xs text-primary hover:text-primary-hover">Forgot password?</Link>
                </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ...
          <Link href="/verify" className="text-primary hover:text-primary-hover font-medium">
            Sign up
          </Link>
        </p>
      </motion.div>
